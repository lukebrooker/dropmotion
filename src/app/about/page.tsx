  ...
  return (
    <div className='max-w-7xl mx-auto px-6'>
      <section className='py-20'>
        <h1 className='text-4xl md:text-5xl font-light mb-12'>About us</h1>
      ...
      <section className='py-32 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/[0.05]'>
        <div className='max-w-3xl mx-auto text-center'>
          ...
          <CTAButton
            href='/contact'
            aria-label='Book your free creative strategy session'
          >
